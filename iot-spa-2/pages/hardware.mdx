...
This initiative employs a network of nodes interconnected through ESP8266 boards, tailored to specific hardware prerequisites:

1. Resilience is paramount; the controller is designed to remain stable amidst frequent network interruptions.
2. Emphasizing flexibility, the system is engineered for wireless communication to suit environments where wired connections are unfeasible.
3. A focus on affordability and reliability in component selection aims to broaden the project's scalability.

These criteria informed the selection of components, which were incorporated following the circuit blueprint detailed in this section.
...
![circuit1.png](/Hardware%20Design%208d69115e2c094635bf28164a67c0d21a/circuit1.png)
...
![WhatsApp Image 2023-12-15 at 18.32.16_1d448848.jpg](/Hardware%20Design%208d69115e2c094635bf28164a67c0d21a/WhatsApp_Image_2023-12-15_at_18.32.16_1d448848.jpg)

                                                              *Fig 1.2: Bridge Node*

The bridge module functions as a communicator, gathering IDs from the client modules and relaying them to the gateway via a serial port. This module operates without the need for any extra physical components.



### **Client Module**

![WhatsApp Image 2023-12-15 at 18.32.16_c9e2f761.jpg](/Hardware%20Design%208d69115e2c094635bf28164a67c0d21a/WhatsApp_Image_2023-12-15_at_18.32.16_c9e2f761.jpg)

                                                                *Fig 1.3: Client Node*

The client module is designed according to the suggested architecture and wired to process feedback from micro-limit switches. It communicates its ID to the bridge wirelessly. With the capacity for multiple clients to interact with a single bridge node, this design significantly enhances the system's scalability.
